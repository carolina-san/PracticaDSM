...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: Dominio_dsmGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        try
        {
                CreateDB.Create ("Dominio_dsmGenNHibernate", "nhibernateUser", "nhibernatePass");
