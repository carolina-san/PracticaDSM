...
public void Modificar (int p_Articulo_OID, string p_nombre, float p_precio, string p_descripcion, DsmGen.ApplicationCore.Enumerated.Dominio_dsm.Talla_artEnum p_talla, string p_recomendaciones, bool p_check_verificado, string p_desc_verificado,string p_marca, int p_stock, bool p_en_stock, string p_color)
{
        ArticuloEN articuloEN = null;
